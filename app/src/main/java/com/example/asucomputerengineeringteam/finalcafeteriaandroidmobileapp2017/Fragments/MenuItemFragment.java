...
import com.example.asucomputerengineeringteam.finalcafeteriaandroidmobileapp2017.Activities.MenuItemDetailsInterface;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        men_upper_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* Intent intent = new Intent(getContext() , MenuItemDetailsInterface.class);
      ...
      /*   MenuItemInterface activity = (MenuItemInterface) getActivity();
       ...
       cat_upper_image.setImageResource(Integer.parseInt(cat_image));
        ...
        Log.v("id", cat_id);
        new JsonTaskMenuItem().execute("http://cafeteriaapptest.azurewebsites.net/api/menuitem/GetByCategory/" + cat_id);
